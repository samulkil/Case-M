# Relatório Teste A/B — Parceiro C
...
|-------|----------------|--------------|---------------|---------------|--------------|
| Grupo 1 | 101 | R$ 382 | 5.0% | 2.0% | 20.0x |
| Grupo 2 | 100 | R$ 373 | 7.0% | 0.0% | 14.3x |
...
**Teste:** Teste t de Student (comparação única, sem correção).

- t = 0.4768 | p = 0.6347
- Nao significativo ao nivel de 95% de confianca (alpha = 0.05)
